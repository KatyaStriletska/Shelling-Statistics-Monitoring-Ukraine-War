...
const GraphLaunchDestrPerCategoryComponent = ({apiUrl}) => {
    ...
    <div>
        <div className='label-container'>
            <h1 className='mb-4 text-4xl font-extrabold leading-none tracking-tight text-green-button md:text-5xl lg:text-4xl dark:text-white'>Weapons launched from the {selectedCategory} category in {selectedYear} year</h1>
        </div>
