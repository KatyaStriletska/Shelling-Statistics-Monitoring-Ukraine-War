...
import './index.css';
export default function CivilianDeathsComponent  ({apiUrl}) {
    ...
    return (
        <div>
            <div className='label-container'>
                <h1 className='mb-4 text-4xl font-extrabold leading-none tracking-tight text-green-button md:text-5xl lg:text-4xl dark:text-white'>Total civilian death over {selectedYear} year</h1>
            </div>
            <div className='ml-[40%]'> 
                {years.map((year) => (
                    <button 
