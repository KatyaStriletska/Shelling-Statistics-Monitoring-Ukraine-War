...
df_massive_attacks = pd.read_csv("/Users/admin/Documents/Shelling-Statistics-Monitoring-Ukraine-War/data/missile_attacks_daily.csv")
...
df_massive_attacks = df_massive_attacks.drop(
    ["launched_details", "launch_place_details", "still_attacking", "cross_border_belarus"], axis=1)
